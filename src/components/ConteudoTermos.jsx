// Conteúdo dos Termos de Uso / Política de Privacidade, extraído da tela
// dedicada (TermosScreen) pra ser reaproveitado também como modal inline no
// cadastro (ver CadastroScreen) -- sem isso, o cadastro tinha que NAVEGAR pra
// uma tela separada pra mostrar o mesmo texto, o que descartava todo o
// progresso preenchido no formulário quando o usuário voltava (ver commit que
// introduziu este componente pro detalhe do porquê).
