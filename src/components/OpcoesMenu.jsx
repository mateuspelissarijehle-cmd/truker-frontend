...
export function OpcoesMenu({ itens, onNavigate, children }) {
  return (
    <>
      ...
      {/* Desktop: só 3 itens hoje -- uma lista empilhada de 600px vira uma
          faixa fina cercada de vazio numa tela larga (achado do Mateus,
          02/09/2026). Cartões lado a lado usam a largura real sem esticar
          pra full-bleed (não faria sentido pra um menu curto). */}
